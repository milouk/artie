...
# Keep the device awake during long batch scrapes. CAFFEINE is provided
# by recent muOS builds; the `command -v` guard makes this a no-op on
# older versions that don't ship it.
